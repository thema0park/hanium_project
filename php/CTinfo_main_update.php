<?php 
	...
	$sql_insert = "insert into Container_info(Container_number,CT_info_env_id,CT_info_manage_id,CT_info_ie_id,Unloding_ship,Shiping_ship,Unloding_port,Shiping_port,Destination,Shiping_cancel) values('$Device_number','$CT_info_env_id','$CT_info_manage_id','$CT_info_ie_id','$Unloding_ship','$Shiping_ship','$Unloding_port','$Shiping_port','$Destination','$Shiping_cancel')";
