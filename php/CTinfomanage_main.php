<?php 
	...
	$sql_insert = "insert into Container_info_management(CT_info_manage_id,Number,Division,Company,Weight,Owner,Damaged,Placement_time,Warning_info,Free_day,Hold)
	values('$CT_info_manage_id','$Number','$Division','$Company','$Weight','$Owner','$Damaged','$Placement_time','$Warning_info','$Free_day','$Hold')";
	...
	$sql_delete = "delete From Container_info_management where CT_info_manage_id=''";
