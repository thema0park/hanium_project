...
<fieldset style = "float:center; padding:10px; width:50%;">
	<legend>장비 정보 입력</legend>
	<form method = "post" action = "http://119.67.32.123:8840/hanium/main.php">
				장비  번호:</br><input type="text" name="equipData" style = "width:300;"></br>
				점검  일시:</br><input type="text" name="checkdata" style = "width:300;"></br>
