...
<?php
        ...
        {
                echo '<tr><td>' .$row['Device_number'] .'</td><td>'. $row['CT_info_env_id'] .'</td><td>'. $row['CT_info_manage_id'] .'</td><td>'. $row['CT_info_ie_id'] .'</td><td>'. $row['Unloding_ship'] .'</td><td>'. $row['Shiping_ship'] .'</td><td>'. $row['Unloding_port'] .'</td><td>'. $row['Shiping_port'] .'</td><td>'. $row['Destination'] .'</td><td>'. $row['Shiping_Cancel'] . '</td></tr>';
	}
        mysqli_close($con);
        ?>
</tbody>
...
<fieldset style = "float:center;padding:10px;width:50%;">
	<legend>컨테이너 정보 입력</legend>
		<form method = "post" action = "http://119.67.32.123:8840/hanium/CTinfo_main.php" >
...
<center>
<fieldset style = "float:center; padding:10px; width:50%;">
	<legend>컨테이너 반입 정보 입력</legend>
		<form method = "post" action = "http://119.67.32.123:8840/hanium/CTinfomanage_main.php" >
			컨테이너 관리정보 ID:</br><input type="text" name="CT_info_manage_id" style = "width:300;"></br>
...
<fieldset style = "float:center; padding:10px; width:50%;">
	<legend>컨테이너 반입 정보 입력</legend>
		<form method = "post" action = "http://119.67.32.123:8840/hanium/CTinfoie_main.php">
